            ...
            <div class="p-3 border-l-2 border-b-0 border-r-2">
                ...
                {{-- Begin Title Input--}}
                    ...
                    <div class="mb-2">
                        ...
                        <input id="title" type="text" class="w-full mt-2 rounded h-8 px-2 border text-gray-600 text-sm {{ $errors->has('title') ? 'border-red-500' : 'border' }}" name="title" value="{{ $component->title }}" autofocus>
                ...
                {{-- Begin Due Date Input --}}
                    ...
                    <div class="mb-2">
                        ...
                        <input id="date_due" type="text" class="w-full mt-2 rounded h-8 px-2 border text-gray-600 text-sm {{ $errors->has('date_due') ? 'border-red-500' : 'border' }}" name="date_due" value="{{Carbon\Carbon::parse($component->date_due)->format('m-d-y') }}" autofocus>
